(function(d, e){
	...
	style.innerHTML += 'position:fixed;right:0;background:rgba(0,0,0,0.2);border-radius:3px;-webkit-user-select:none;}';
	style.innerHTML += 'nav.alphabetList ul{';
	style.innerHTML += 'list-style:none;padding:0;margin:0;}';
	style.innerHTML += 'nav.alphabetList ul li{padding:10px;}';
	style.innerHTML += 'div.alphabetIndicator{';
	style.innerHTML += 'position:fixed;display:none;left:50%;top:50%;width:50px;height:50px;background:rgba(0,0,0,0.2);';
